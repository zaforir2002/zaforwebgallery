<div class="usersContacts index">
	<h2><?php echo __('Users Contacts'); ?></h2>
	...
	<tr>
		<td><?php echo h($usersContact['UsersContact']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($usersContact['UsersContact']['created']); ?>&nbsp;</td>
		<td><?php echo h($usersContact['UsersContact']['modified']); ?>&nbsp;</td>
		<td class="actions">
