<div class="galleryEvents index">
	...
	<tr>
		<td><?php echo h($galleryEvent['GalleryEvent']['id']); ?>&nbsp;</td>
		<td><?php echo h($galleryEvent['GalleryEvent']['title']); ?>&nbsp;</td>
		<td><?php echo h($galleryEvent['GalleryEvent']['location']); ?>&nbsp;</td>
		<td><?php echo h($galleryEvent['GalleryEvent']['event_start_date']); ?>&nbsp;</td>
		<td><?php echo h($galleryEvent['GalleryEvent']['event_end_date']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($galleryEvent['User']['full_name'], array('controller' => 'users', 'action' => 'view', $galleryEvent['User']['id'])); ?>
		</td>
		<td><?php echo h($galleryEvent['GalleryEvent']['created']); ?>&nbsp;</td>
		<td><?php echo h($galleryEvent['GalleryEvent']['modified']); ?>&nbsp;</td>
		<td class="actions">
