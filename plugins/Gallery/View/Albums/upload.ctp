                                        ...
                                        <div class="thumbnail th-pictures-container" style="position: relative">
                                            ...
                                            <script>
                                                function edit_picture_sale<?php echo $PicNo; ?>(){
                                                    document.getElementById("picture<?php echo $PicNo; ?>").innerHTML='<object type="text/html" data="/gallerypictures/edit/<?php echo $picture['id'] . '/' . $album['Album']['id']; ?>" height="250" width="200"></object>';
                                                }
